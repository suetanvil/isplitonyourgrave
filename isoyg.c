...
# unix-like machine with gcc installed.  (OSX's clang is sufficiently
# gcc-like for this purpose.)
#
# If this doesn't work, revise the line below to work on your system.
